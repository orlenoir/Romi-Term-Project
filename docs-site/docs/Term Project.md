...
The state estimator was used to drive straight left in the garage until it hit the wall at the end. 
Bump sensor triggered and romi turned left and followed the line, then at the plus turns left again and pushes the red cup from the circle on the left to the circle on the right.
